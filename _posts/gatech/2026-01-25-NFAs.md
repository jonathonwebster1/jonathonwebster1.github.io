...
flowchart LR
    ...
    %% Accepting state after reversal: S0
    nS0(((S0)))
    ...
    %% Reverse of: S2 --ε--> U0 and S2 --ε--> F
    nU0((U0)) -->|ε| nS2
    nF -->|ε| nS2

    %% Reverse of: U0 --ε--> A0 and U0 --ε--> B0
    nA0((A0)) -->|ε| nU0
    nB0((B0)) -->|ε| nU0

    %% Reverse of: A0 --a--> A1 and B0 --b--> B1
    nA1((A1)) -->|a| nA0
    nB1((B1)) -->|b| nB0

    %% Reverse of: A1 --ε--> U1 and B1 --ε--> U1
    nU1((U1)) -->|ε| nA1
    nU1 -->|ε| nB1

    %% Reverse of: U1 --ε--> U0 and U1 --ε--> F
    nU0 -->|ε| nU1
    nF -->|ε| nU1
```
